    ...
    public void pridatNovouKnihu(Scanner scanner) {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            default:
                System.out.println("Neplatná volba, vyberte jednu z možností, odpovídající výběru ");
        }
    }
        ...
        if (kniha != null) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                default:
                    System.out.println("Neplatná volba, zvolte odpovídající možnost ");
            }
        }
    }

    	public kniha najitKnihu(String nazev) {
        for (kniha kniha : knihovnaSeznam) {     
